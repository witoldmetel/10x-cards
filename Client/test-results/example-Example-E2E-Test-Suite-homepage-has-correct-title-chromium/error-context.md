...
- Name: Example E2E Test Suite >> homepage has correct title
- Location: /Users/witoldmetel/Projects/10x-cards/Client/src/e2e/example.spec.ts:12:3
...
Expected pattern: /10x Cards/
Received string:  "10xCards"
Call log:
  - expect.toHaveTitle with timeout 5000ms
  - waiting for locator(':root')
    9 × locator resolved to <html lang="en">…</html>
      - unexpected value "10xCards"

    at /Users/witoldmetel/Projects/10x-cards/Client/src/e2e/example.spec.ts:13:24
```
